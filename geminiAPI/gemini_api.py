...
def configure_gemini():
    try:
        api_key = "AIzaSyA2qIpsmTRxj7HlgdfitOVaHgFgEJ8M0aM"  # Replace with your actual API key
...
def get_response():
    ...
    try:
        ...
        # Assuming response is a JSON string like '[{"animeName": "animeName1"}, {"animeName": "animeName2"}]'
        return jsonify({"recommended_animes": response})
    except Exception as e:
